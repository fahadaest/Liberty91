...
export const Sidebar = () => {
  ...
  const themeClass = layout.options.sidebar.theme === 'light' || pathname === '/dark-sidebar' ? 'dark [&.dark]:bg-customDark' : 'dark:bg-customDark';
  ...
  const renderContent = () => {
    return <div ref={selfRef} onMouseLeave={handleMouseLeave} onMouseEnter={handleMouseEnter} className={clsx('sidebar bg-customDark lg:border-e lg:border-e-gray-200 dark:border-e-coal-100 lg:fixed lg:top-0 lg:bottom-0 lg:z-20 lg:flex flex-col items-stretch shrink-0', themeClass)}>
